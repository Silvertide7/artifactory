...
public class AttunementNexusManageMenu extends AbstractContainerMenu {
    ...
    public AttunementNexusManageMenu(int containerId, Inventory playerInventory, FriendlyByteBuf extraData) {
        this(containerId, playerInventory, ContainerLevelAccess.NULL);
    }

    public AttunementNexusManageMenu(int containerId, Inventory playerInventory, ContainerLevelAccess access) {
