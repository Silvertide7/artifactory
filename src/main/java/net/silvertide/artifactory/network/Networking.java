...
public class Networking {
    ...
    public static void registerMessages(RegisterPayloadHandlersEvent event) {
        ...
        registrar
                ...
                .playToClient(CB_UpdateAttunementNexusSlotInformation.TYPE, CB_UpdateAttunementNexusSlotInformation.STREAM_CODEC, CB_UpdateAttunementNexusSlotInformation::handle)
